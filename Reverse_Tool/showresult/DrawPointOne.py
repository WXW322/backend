...
plt.annotate('HTTP', xy=(.8333, .7000), xytext=(.8333, .7100), size=10)
plt.annotate('HTTP', xy=(.5000, .6000), xytext=(.5000, .6100), size=10)
plt.annotate('HTTP', xy=(.6667, .8000), xytext=(.6667, .8100), size=10)
...
plt.tight_layout()
plt.savefig('/home/wxw/paper/researchresult/text/classify/clsNew.jpg')
